...
- Bump Java SDK from v8.6.0 to v8.58.0 ([#1](https://github.com/phunkeler/sentry-dotnet/pull/1))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8580)
  - [diff](https://github.com/getsentry/sentry-java/compare/8.6.0...8.58.0)
